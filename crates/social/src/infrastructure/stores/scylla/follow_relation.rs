...
use crate::{domain::entities::FollowRelation, repositories::FollowRelationRepository};

pub struct ScyllaFollowRelationStore {
    session: Arc<Session>,
...
impl ScyllaFollowRelationStore {
...
#[async_trait]
impl FollowRelationRepository for ScyllaFollowRelationStore {
