...
pub trait AccountRepository: Send + Sync {
    async fn fetch_by_id(&self, id: &AccountId, tx: Option<&mut dyn Transaction>) -> Result<Option<Account>>;
    ...
    async fn save(&self, account: &Account, original: Option<&Account>, tx: Option<&mut dyn Transaction>) -> Result<()>;
