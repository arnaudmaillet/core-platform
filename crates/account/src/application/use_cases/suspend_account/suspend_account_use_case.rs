...
use crate::application::use_cases::suspend_account::SuspendAccountCommand;
...
impl SuspendAccountUseCase {
    ...
    pub async fn execute(&self, command: SuspendAccountCommand) -> Result<Account> {
    ...
    async fn try_execute_once(&self, cmd: &SuspendAccountCommand) -> Result<Account> {
