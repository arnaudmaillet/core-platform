...
use crate::application::use_cases::unban_account::UnbanAccountCommand;
use crate::domain::entities::account::Account;
use crate::domain::repositories::AccountRepository;

pub struct UnbanAccountUseCase {
    repo: Arc<dyn AccountRepository>,
    outbox: Arc<dyn OutboxRepository>,
    tx_manager: Arc<dyn TransactionManager>,
}

impl UnbanAccountUseCase {
    pub fn new(
        repo: Arc<dyn AccountRepository>,
        outbox: Arc<dyn OutboxRepository>,
        tx_manager: Arc<dyn TransactionManager>,
    ...
    pub async fn execute(&self, command: UnbanAccountCommand) -> Result<Account> {
    ...
    async fn try_execute_once(&self, cmd: &UnbanAccountCommand) -> Result<Account> {
