...
impl SuspendUseCase {
    ...
    pub async fn execute(&self, ctx: &AccountContext, cmd: SuspendCommand) -> Result<AccountIdentity> {
    ...
    async fn try_execute_once(&self, ctx: &AccountContext, cmd: &SuspendCommand) -> Result<AccountIdentity> {
