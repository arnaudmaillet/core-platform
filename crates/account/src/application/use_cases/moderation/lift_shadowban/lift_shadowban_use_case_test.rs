...
mod tests {
    ...
    use crate::application::use_cases::moderation::lift_shadowban::{LiftShadowbanCommand, LiftShadowbanUseCase};
    ...
    async fn test_lift_shadowban_idempotency() {
        ...
        let initial_metadata = AccountMetadata::builder(account_id.clone()).build();
