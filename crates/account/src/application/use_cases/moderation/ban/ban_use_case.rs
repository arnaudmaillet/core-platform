...
use crate::application::use_cases::moderation::ban::BanCommand;
...
impl BanUseCase {
    ...
    pub async fn execute(&self, ctx: &AccountContext, cmd: BanCommand) -> Result<AccountIdentity> {
