...
use crate::application::use_cases::deactivate_account::DeactivateAccountCommand;
...
impl DeactivateAccountUseCase {
    ...
    pub async fn execute(&self, command: DeactivateAccountCommand) -> Result<Account> {
    ...
    async fn try_execute_once(&self, cmd: &DeactivateAccountCommand) -> Result<Account> {
