#[cfg(test)]
mod tests {
    use crate::application::use_cases::settings::set_as_beta::{SetAsBetaCommand, SetAsBetaUseCase};
    ...
    fn setup() -> (
        ...
        let use_case =
            SetAsBetaUseCase::new(metadata_repo.clone(), outbox_repo.clone(), tx_manager);
