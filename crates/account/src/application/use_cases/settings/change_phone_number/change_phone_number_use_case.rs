...
impl ChangePhoneNumberUseCase {
    ...
    pub async fn execute(&self, ctx: &AccountContext, cmd: ChangePhoneNumberCommand) -> Result<AccountIdentity> {
    ...
    async fn try_execute_once(&self, ctx: &AccountContext, cmd: &ChangePhoneNumberCommand) -> Result<AccountIdentity> {
