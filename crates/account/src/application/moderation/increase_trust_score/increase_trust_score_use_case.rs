...
use crate::application::moderation::increase_trust_score::IncreaseTrustScoreCommand;
...
impl IncreaseTrustScoreUseCase {
    ...
    pub async fn execute(&self, command: IncreaseTrustScoreCommand) -> Result<AccountMetadata> {
