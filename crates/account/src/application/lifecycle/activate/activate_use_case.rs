...
impl ReactivateUseCase {
    ...
    pub async fn execute(&self, command: ActivateCommand) -> Result<AccountIdentity> {
    ...
    async fn try_execute_once(&self, cmd: &ActivateCommand) -> Result<AccountIdentity> {
