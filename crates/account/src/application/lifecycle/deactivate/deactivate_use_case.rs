...
use crate::application::lifecycle::deactivate::DeactivateCommand;
...
impl DeactivateUseCase {
    ...
    pub async fn execute(&self, command: DeactivateCommand) -> Result<Account> {
    ...
    async fn try_execute_once(&self, cmd: &DeactivateCommand) -> Result<Account> {
