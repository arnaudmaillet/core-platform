...
use crate::domain::entities::{AccountSettings, AppearanceSettings, PrivacySettings};
...
mod tests {
    ...
    use crate::application::update_account_settings::{UpdateAccountSettingsCommand, UpdateAccountSettingsUseCase};
