...
use shared_kernel::domain::value_objects::{RegionCode, AccountId, LocationLabel};
use crate::application::update_bio::{UpdateBioUseCase, UpdateBioCommand};
use crate::application::update_location_label::{UpdateLocationLabelCommand, UpdateLocationLabelUseCase};
use crate::application::update_social_links::{UpdateSocialLinksUseCase, UpdateSocialLinksCommand};
use crate::domain::value_objects::{Bio, SocialLinks};
// Proto généré
use super::super::profile_v1::{
    profile_metadata_service_server::ProfileMetadataService,
    UpdateBioRequest,
    UpdateLocationLabelRequest,
...
impl ProfileMetadataService for MetadataHandler {
    ...
    async fn update_bio(
        ...
        let command = UpdateBioCommand { account_id, region, new_bio };
    ...
    async fn update_location_label(
        ...
        let command = UpdateLocationLabelCommand { account_id, region, new_location };
    ...
    async fn update_social_links(
        ...
        let command = UpdateSocialLinksCommand { account_id, region, new_links };
