...
pub struct StubMapPersistenceRepository {
    state: RwLock<
        HashMap<PartitionKey, HashMap<PostId, (ActiveMapPost, std::time::Instant, Duration)>>,
    >,
}

impl Default for StubMapPersistenceRepository {
    fn default() -> Self {
        Self::new()
    }
}

impl StubMapPersistenceRepository {
    pub fn new() -> Self {
        Self {
...
#[async_trait]
impl MapPersistenceRepository for StubMapPersistenceRepository {
