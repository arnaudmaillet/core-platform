...
pub struct MapCacheRepositoryStub {
...
impl Default for MapCacheRepositoryStub {
    fn default() -> Self {
        Self::new()
    }
}

impl MapCacheRepositoryStub {
    pub fn new() -> Self {
        Self {
...
#[async_trait]
impl MapAnnotationDiscoveryRepository for MapCacheRepositoryStub {
    async fn add_to_tile(
        ...
        pop_guard
            .entry(key.clone())
            .or_default()
            .insert(post_id, popularity_score.value());
