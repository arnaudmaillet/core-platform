...
mod tests {
    ...
    use post::{
        builders::MediaAssetBuilder,
        types::{DurationSeconds, Height, MediaId, MediaType, MimeType, Width},
    };
    ...
    fn test_media_asset_valid_video() {
        ...
        let asset = MediaAssetBuilder::new(id, url, thumb, dur, w, h, mtype, mime)
            .build()
            .unwrap();
    ...
    fn test_media_asset_valid_image() {
        let asset = MediaAssetBuilder::new(
            MediaId::generate(),
    ...
    fn test_media_asset_image_with_duration_fails() {
        let result = MediaAssetBuilder::new(
            MediaId::generate(),
            Url::try_new("https://cdn.wynn.com/img.jpg").unwrap(),
            Url::try_new("https://cdn.wynn.com/thumb.jpg").unwrap(),
