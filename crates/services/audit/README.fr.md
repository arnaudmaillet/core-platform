...
i18n:
  source: ./README.md
  source_sha256: 2987f441af48ab77ae9d5b8207b0112eb5f13cf8331ac9afe0e84294f3c5a886
...
| `account.v1.events` ✅ câblé | `audit-account` | `account_created` / `email_changed` (PII scellée dans une enveloppe crypto-effaçable), `gdpr_data_export_requested`, et `gdpr_deletion_requested` — qui **crypto-efface aussi le sujet** (Art. 17, boucle bouclée) ; les autres variants sont un skip inoffensif | DLQ `account.v1.events.dlq` |
