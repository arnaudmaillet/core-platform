...
mod redis_cache_integration_tests {
    ...
    async fn test_add_to_tile_and_get_top_posts_lifecycle() -> Result<()> {
        ...
        repo.add_to_tile(
            ...
            &tile_id,
            &meta_2,
            PopularityScore::from_raw(150.0),
            expires_at,
        )
        .await?;
