...
use crate::application::context::GeoDiscoveryKernelCtx;

pub struct CacheEvictionWorker {
    app_ctx: Arc<GeoDiscoveryKernelCtx>,
    execution_interval: Duration,
}

impl CacheEvictionWorker {
    pub fn new(app_ctx: Arc<GeoDiscoveryKernelCtx>, execution_interval: Duration) -> Self {
        Self {
            app_ctx,
            execution_interval,
        }
