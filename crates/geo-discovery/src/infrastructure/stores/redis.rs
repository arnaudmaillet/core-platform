...
use crate::domain::repositories::MapAnnotationDiscoveryRepository;
...
pub struct RedisMapAnnotationStore {
    pool: Pool,
}

impl RedisMapAnnotationStore {
...
#[async_trait]
impl MapAnnotationDiscoveryRepository for RedisMapAnnotationStore {
    async fn add_to_tile(
        ...
        let pop_values = vec![(popularity_score.value(), post_id_str.clone())];
