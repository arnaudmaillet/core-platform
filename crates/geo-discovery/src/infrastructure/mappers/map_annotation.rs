...
pub struct CqlMapAnnotationRow {
...
impl TryFrom<CqlMapAnnotationRow> for MapAnnotation {
    type Error = Error;

    fn try_from(row: CqlMapAnnotationRow) -> Result<Self> {
