...
use crate::Media;
use crate::media::domain::types::{DurationSeconds, Height, MediaId, MediaType, MimeType, Width};
use crate::media::infrastructure::ScyllaMediaModel;

use shared_kernel::core::{Identifier, Result};
use shared_kernel::types::Url;

/// Convertit le MediaAsset du Domaine en Row Scylla
impl From<&Media> for ScyllaMediaModel {
    fn from(domain: &Media) -> Self {
        Self {
...
impl TryFrom<ScyllaMediaModel> for Media {
