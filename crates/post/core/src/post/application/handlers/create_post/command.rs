...
use crate::Media;
use crate::media::types::{DurationSeconds, Height, MediaId, MediaType, MimeType, Width};
use crate::post::types::{Caption, DynamicMetadata};
use post_proto_bridge::v1::CreatePostRequest;
use post_proto_bridge::v1::MediaAsset as ProtoMedia;
...
impl Media {
    pub fn from_proto(proto: ProtoMedia) -> Result<Self> {
        Ok(Self::restore(
