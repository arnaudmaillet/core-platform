...
pub struct Profile {
    ...
    #[prost(message, optional, tag = "10")]
    pub socials: ::core::option::Option<Socials>,
    #[prost(bool, tag = "11")]
    pub is_private: bool,
...
pub struct UpdateLocationRequest {
    ...
    pub target: ::core::option::Option<ProfileTarget>,
    #[prost(message, optional, tag = "3")]
    pub new_location: ::core::option::Option<::prost::alloc::string::String>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct UpdateSocialsRequest {
    ...
    pub target: ::core::option::Option<ProfileTarget>,
    #[prost(message, optional, tag = "3")]
    pub new_socials: ::core::option::Option<Socials>,
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct GetProfilesByAccountRequest {
    #[prost(message, optional, tag = "1")]
    pub metadata: ::core::option::Option<QueryMetadata>,
    #[prost(string, tag = "2")]
    pub account_id: ::prost::alloc::string::String,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetProfilesByAccountResponse {
...
pub mod profile_identity_service_client {
    ...
    /// 1. SERVICE D'IDENTITÉ : Gère les informations pivots du compte
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn change_handle(
            &mut self,
            request: impl tonic::IntoRequest<super::ChangeHandleRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ChangeHandleResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("profile.v1.ProfileIdentityService", "ChangeHandle"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn update_display_name(
            ...
            tonic::Response<super::UpdateDisplayNameResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn update_privacy(
            ...
            tonic::Response<super::UpdatePrivacyResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/profile.v1.ProfileIdentityService/ChangeHandle" => {
                    ...
                    impl<
                        T: ProfileIdentityService,
                    > tonic::server::UnaryService<super::ChangeHandleRequest>
                    for ChangeHandleSvc<T> {
                        type Response = super::ChangeHandleResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ProfileIdentityService>::change_handle(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ChangeHandleSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/profile.v1.ProfileIdentityService/UpdateDisplayName" => {
                    ...
                    for UpdateDisplayNameSvc<T> {
                        type Response = super::UpdateDisplayNameResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                ...
                "/profile.v1.ProfileIdentityService/UpdatePrivacy" => {
                    ...
                    for UpdatePrivacySvc<T> {
                        type Response = super::UpdatePrivacyResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
...
pub mod profile_media_service_client {
    ...
    use tonic::codegen::*;
    use tonic::codegen::http::Uri;
    /// 2. SERVICE DE MÉDIAS (ASSETS) : Gère les images de profil
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn update_avatar(
            ...
            tonic::Response<super::UpdateAvatarResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn remove_avatar(
            ...
            tonic::Response<super::RemoveAvatarResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn update_banner(
            ...
            tonic::Response<super::UpdateBannerResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn remove_banner(
            ...
            tonic::Response<super::RemoveBannerResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            match req.uri().path() {
                "/profile.v1.ProfileMediaService/UpdateAvatar" => {
                    ...
                    for UpdateAvatarSvc<T> {
                        type Response = super::UpdateAvatarResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                ...
                "/profile.v1.ProfileMediaService/RemoveAvatar" => {
                    ...
                    for RemoveAvatarSvc<T> {
                        type Response = super::RemoveAvatarResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                ...
                "/profile.v1.ProfileMediaService/UpdateBanner" => {
                    ...
                    for UpdateBannerSvc<T> {
                        type Response = super::UpdateBannerResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                ...
                "/profile.v1.ProfileMediaService/RemoveBanner" => {
                    ...
                    for RemoveBannerSvc<T> {
                        type Response = super::RemoveBannerResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
...
pub mod profile_metadata_service_client {
    ...
    use tonic::codegen::*;
    use tonic::codegen::http::Uri;
    /// 3. SERVICE DE MÉTADONNÉES : Gère les infos éditoriales et sociales
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn update_bio(
            ...
            tonic::Response<super::UpdateBioResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/profile.v1.ProfileMetadataService/UpdateLocation",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn update_socials(
            &mut self,
            request: impl tonic::IntoRequest<super::UpdateSocialsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::UpdateSocialsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/profile.v1.ProfileMetadataService/UpdateSocials",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("profile.v1.ProfileMetadataService", "UpdateSocials"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod profile_metadata_service_server {
    ...
    pub trait ProfileMetadataService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn update_socials(
            &self,
            request: tonic::Request<super::UpdateSocialsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::UpdateSocialsResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/profile.v1.ProfileMetadataService/UpdateBio" => {
                    ...
                    for UpdateBioSvc<T> {
                        type Response = super::UpdateBioResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                ...
                "/profile.v1.ProfileMetadataService/UpdateLocation" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateLocationSvc<T: ProfileMetadataService>(pub Arc<T>);
                    impl<
                        T: ProfileMetadataService,
                    ...
                    for UpdateLocationSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ProfileMetadataService>::update_location(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/profile.v1.ProfileMetadataService/UpdateSocials" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateSocialsSvc<T: ProfileMetadataService>(pub Arc<T>);
                    impl<
                        T: ProfileMetadataService,
                    > tonic::server::UnaryService<super::UpdateSocialsRequest>
                    for UpdateSocialsSvc<T> {
                        type Response = super::UpdateSocialsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ProfileMetadataService>::update_socials(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateSocialsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
...
pub mod profile_query_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_profile(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/profile.v1.ProfileQueryService/GetProfile",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("profile.v1.ProfileQueryService", "GetProfile"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_profiles_by_account(
            &mut self,
            request: impl tonic::IntoRequest<super::GetProfilesByAccountRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/profile.v1.ProfileQueryService/GetProfilesByAccount",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod profile_query_service_server {
    ...
    pub trait ProfileQueryService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_profiles_by_account(
            &self,
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/profile.v1.ProfileQueryService/GetProfile" => {
                    #[allow(non_camel_case_types)]
                    struct GetProfileSvc<T: ProfileQueryService>(pub Arc<T>);
                    impl<
                        T: ProfileQueryService,
                    ...
                    for GetProfileSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ProfileQueryService>::get_profile(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/profile.v1.ProfileQueryService/GetProfilesByAccount" => {
                    #[allow(non_camel_case_types)]
                    struct GetProfilesByAccountSvc<T: ProfileQueryService>(pub Arc<T>);
                    impl<
                        T: ProfileQueryService,
                    > tonic::server::UnaryService<super::GetProfilesByAccountRequest>
                    for GetProfilesByAccountSvc<T> {
                        type Response = super::GetProfilesByAccountResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ProfileQueryService>::get_profiles_by_account(
                                        &inner,
                                        request,
                                    )
                                    .await
